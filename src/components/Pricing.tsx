                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
                    ...
                    {bannerText ? (
                        <div className="w-full lg:w-auto flex justify-center my-4">
                            <p className="w-full px-4 py-3 text-xs bg-green-100 text-black dark:bg-green-300/30 dark:text-white/80 rounded-xl">
                                {bannerText}
                            </p>
                        </div>
                    ) : null}
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            !tier.highlighted && !tier.featured
                                                ...
                                                : 'bg-green-300/70 text-green-foreground hover:bg-green-400/70 dark:bg-green-700 dark:hover:bg-green-800/90',
